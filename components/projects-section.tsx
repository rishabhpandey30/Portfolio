  ...
  const projects = [
    {
      title: "LeaveSync",
      description:
        "A leave management system developed to streamline employee leave requests, approvals, and tracking within organizations. Enhances workflow efficiency through automation and transparent record management.",
    ...
    },
    {
      title: "FinTracker",
      description:
        "A personal finance management web application that enables users to track expenses, manage budgets, and analyze spending patterns effectively. Designed with a user-friendly interface and real-time data processing for better financial insights.",
      ...
      highlights: [
        ...
        "Interactive Data Visualization (Charts & Reports)",
      ],
    ...
    },
    {
      ...
      description:
        "An interactive data visualization dashboard built using Power BI to analyze Uber ride data, uncover trends, and provide actionable insights for business decision-making. Designed to present complex data in a clear and visually appealing manner.",
