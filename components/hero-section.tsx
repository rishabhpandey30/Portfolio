...
export function HeroSection() {
  ...
  const downloadCV = () => {
    ...
    const directDownloadUrl = "https://drive.google.com/file/d/1gccwCSqIzdwqmurkTXY_wRABo_Rcs_p1/view?usp=drive_link"
    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="text-center space-y-8">
          {/* Profile Image */}
          <div className="relative mx-auto w-48 h-48 sm:w-56 sm:h-56 rounded-full overflow-hidden border-4 border-primary/20 shadow-2xl">
            <Image
              src="/rishabh-pandey-photo.png"
              alt="Rishabh Pandey - Professional Photo"
              fill
              priority
              className="object-cover object-[center_75%] scale-[1.35]"
            />
          </div>
